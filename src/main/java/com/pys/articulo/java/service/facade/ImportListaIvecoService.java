package com.pys.articulo.java.service.facade;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.json.JsonMapper;
import com.pys.articulo.java.exception.CotizacionException;
import com.pys.articulo.java.service.*;
...
//                try {
//                    log.debug("Articulo Procesado: {}", JsonMapper.builder().findAndAddModules().build().writerWithDefaultPrettyPrinter().writeValueAsString(articulo));
//                } catch (JsonProcessingException e) {
